...
class CompanyInfo
    ...
    def get_stock_info()
        ...
        doc = get_nokogiri_doc(url)
        @recentHighPrice = doc.xpath("//*[@id=\"main\"]/div[7]/div[2]/div[2]/div[11]/dl/dd/strong").text
        @recentLowPrice = doc.xpath("//*[@id=\"main\"]/div[7]/div[2]/div[2]/div[12]/dl/dd/strong").text
